...
| `Transition.Show` | The room wipe (`SlantedWipe` of `ScreenFade`): phase and progress, display, picking mode, duration, colors, and the element the pointer picks at the middle of the screen (`nothing` = the game gets it) |
