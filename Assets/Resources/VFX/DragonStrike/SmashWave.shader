...
Shader "Komorebi/Dragonstrike/Ground"
{
	Properties
	{
		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float3 texCoord17 = i.texcoord.xyz;
					texCoord17.xy = i.texcoord.xyz.xy * float2( 1,1 ) + float2( 0,0 );
					float2 appendResult18 = (float2(0.0 , texCoord17.z));
					float2 texCoord14 = i.texcoord.xy * _MainTiling + appendResult18;
					float4 temp_output_10_0 = ( _TintColor * ( tex2D( _BorderTexture, uv_BorderTexture ).r + tex2D( _MainTex, texCoord14 ).r ) * i.color );
					float2 texCoord62 = i.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float4 texCoord35 = i.ase_texcoord3;
					texCoord35.xy = i.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
					float smoothstepResult63 = smoothstep( 0.0 , _GradientStep , ( 1.0 - ( texCoord62.y + texCoord35.w ) ));
...
Node;AmplifyShaderEditor.Vector2Node;46;-1429.011,-126.0621;Float;False;Property;_MainTiling;Main Tiling;2;0;Create;True;0;0;0;False;0;False;0,0;2.5,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;9;-1196.64,-22.58556;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-935.5936,46.56829;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;48;-948.8633,-197.8019;Inherit;True;Property;_BorderTexture;Border Texture;1;0;Create;True;0;0;0;False;0;False;-1;None;c08287335df0f1b43820e27dee902611;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-562.8651,702.0432;Float;False;Property;_GradientStep;Gradient Step;0;0;Create;True;0;0;0;False;0;False;-0.1;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;7;-487.4147,-228.9405;Inherit;False;0;0;_TintColor;Shader;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;69;759.1011,-97.57652;Float;False;True;-1;2;ASEMaterialInspector;0;11;Komorebi/Dragonstrike/Ground;0b6a9f8b4f707c74ca64c0be8e590de0;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;False;True;2;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;True;True;True;True;False;0;False;;False;False;False;False;False;False;False;False;False;True;2;False;;True;3;False;;False;True;4;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;0;;0;0;Standard;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=888B0A59515EB360CB788EC4467B64A6146698BB