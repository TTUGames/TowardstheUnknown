...
Shader "Komorebi/DragonStrike/Aura"
{
	Properties
	{
		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float2 texCoord104 = i.texcoord.xy * (_MainTilingOffset).xy + appendResult102;
					float2 uv_Noise1Texture = i.texcoord.xy * _Noise1Texture_ST.xy + _Noise1Texture_ST.zw;
					float2 panner13 = ( 1.0 * _Time.y * (_Speed).xy + uv_Noise1Texture);
					float4 tex2DNode5 = tex2D( _Noise1Texture, panner13 );
					float2 uv_Noise2Texture = i.texcoord.xy * _Noise2Texture_ST.xy + _Noise2Texture_ST.zw;
					float2 panner14 = ( 1.0 * _Time.y * (_Speed).zw + uv_Noise2Texture);
					...
					float staticSwitch76 = ( tex2DNode5.r * tex2DNode6.r );
					#endif
					float4 texCoord79 = i.texcoord;
					texCoord79.xy = i.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float temp_output_81_0 = ( texCoord79.z + _MaskTextureOffset );
					...
					float2 staticSwitch171 = appendResult172;
					#endif
					float2 texCoord128 = i.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					#if defined(_MASKTEXTUREOFFSETAXIS_U)
					float staticSwitch175 = texCoord128.y;
					#elif defined(_MASKTEXTUREOFFSETAXIS_V)
					float staticSwitch175 = texCoord128.x;
					#else
					float staticSwitch175 = texCoord128.y;
					#endif
					...
					#endif
					float4 tex2DNode26 = tex2D( _MainTex, ( texCoord104 + ( ( staticSwitch76 * staticSwitch171 ) * staticSwitch133 ) ) );
					...
					float staticSwitch83 = texCoord28.x;
					#elif defined(_GRADIENTUV_V)
					float staticSwitch83 = texCoord28.y;
					#else
					float staticSwitch83 = texCoord28.x;
					#endif
					...
					float4 texCoord53 = i.texcoord;
					texCoord53.xy = i.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					#ifdef _USENOISEOPACITY_ON
					float staticSwitch183 = step( saturate( noise_opacity67 ) , ( 1.0 - ( _Opacity + texCoord53.w ) ) );
					#else
...
/*ASEBEGIN
Version=19100
Node;AmplifyShaderEditor.Vector4Node;9;-2700.473,-168.9056;Float;False;Property;_Speed;Speed;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.05,-0.15,-0.05,-0.2;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-1488.004,609.5051;Float;False;Property;_MaskTextureOffset;Mask Texture Offset;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;6;-1795.513,50.17901;Inherit;True;Property;_Noise2Texture;Noise 2 Texture;2;0;Create;True;0;0;0;False;0;False;-1;None;6da64f90d187eda4a85ce02732d2883c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;5;-1800.482,-320.0666;Inherit;True;Property;_Noise1Texture;Noise 1 Texture;1;0;Create;True;0;0;0;False;0;False;-1;None;6da64f90d187eda4a85ce02732d2883c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;70;-1024.803,-851.4699;Float;False;Property;_MainTilingOffset;Main Tiling Offset;0;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;80;-1222.944,239.7939;Float;False;Constant;_Float1;Float 1;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;76;-942.1488,-37.27603;Float;False;Property;_NoiseBlend;NoiseBlend;5;0;Create;True;0;0;0;False;0;False;0;0;1;True;;KeywordEnum;3;Multiply;Lerp;Add;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;171;-823.7712,291.7636;Float;False;Property;_MaskTextureOffsetAxis;Mask Texture Offset Axis;16;0;Create;True;0;0;0;False;0;False;0;0;0;True;;KeywordEnum;2;U;V;Create;True;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;134;-380.0703,276.4225;Float;False;Constant;_Float2;Float 2;17;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;175;-656.8396,530.7057;Float;False;Property;_Keyword0;Keyword 0;16;0;Create;True;0;0;0;False;0;False;0;0;0;True;;KeywordEnum;2;U;V;Reference;171;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;133;-146.9348,216.032;Float;False;Property;_UseNoiseUVGradient;Use Noise UV Gradient;14;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;25;464.9892,-540.976;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;89;723.0566,-228.4292;Float;False;Property;_Adjust;Adjust;6;0;Create;True;0;0;0;False;0;False;0;0.413;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;26;724.4151,-468.8641;Inherit;True;Property;_TextureSample0;Texture Sample 0;4;0;Create;True;0;0;0;False;0;False;-1;76d073b7506b31444a45e9077ac1d0e0;76d073b7506b31444a45e9077ac1d0e0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;92;1022.428,-197.6338;Float;False;Property;_SmoothstepMin;Smoothstep Min;7;0;Create;True;0;0;0;False;0;False;0;0.458;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;93;1017.212,-94.97769;Float;False;Property;_SmoothstepMax;Smoothstep Max;8;0;Create;True;0;0;0;False;0;False;1;0.776;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;83;483.941,883.08;Float;False;Property;_GradientUV;Gradient UV;9;0;Create;True;0;0;0;False;0;False;0;0;1;True;;KeywordEnum;2;U;V;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;156;-890.8839,-391.8233;Float;False;Property;_NoiseOpacity;NoiseOpacity;12;0;Create;True;0;0;0;False;0;False;0;0;2;True;;KeywordEnum;3;Noise1;Noise2;BlendNoise;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;919.5829,990.5677;Float;False;Property;_UVGradientOffset;UV Gradient Offset;10;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;184;1662.183,-475.7359;Inherit;False;Property;_BlendTextures;Blend Textures;19;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;1847.655,-15.80825;Float;False;Property;_Opacity;Opacity;13;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;141;1746.459,-724.8311;Float;False;Constant;_Float3;Float 3;18;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;86;1290.708,1121.195;Float;False;Property;_UVGradientAdjust;UV Gradient Adjust;11;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;3;2308.659,-914.0186;Inherit;False;0;0;_TintColor;Shader;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;119;2623.569,-150.1439;Float;False;Constant;_Float0;Float 0;18;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;183;2794.226,-52.44406;Inherit;False;Property;_UseNoiseOpacity;Use Noise Opacity;18;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;177;-521.2391,700.692;Float;False;Property;_Float4;Float 4;17;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;186;3620.309,-610.2775;Float;False;True;-1;2;ASEMaterialInspector;0;11;Komorebi/DragonStrike/Aura;0b6a9f8b4f707c74ca64c0be8e590de0;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;False;True;2;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;True;True;True;True;False;0;False;;False;False;False;False;False;False;False;False;False;True;2;False;;True;3;False;;False;True;4;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;0;;0;0;Standard;0;0;1;True;False;;False;0
...
WireConnection;186;0;32;0
ASEEND*/
//CHKSM=58E8594B63F19D2A232D4A58D1175F2CEC821D0B