// Blend Center Glow Strong: a center glow particle (Rendering/VFX/CenterGlow.hlsl), blended with its alpha, its opacity going up to 3 (Hantise)
Shader "Towards the Unknown/VFX/Blend Center Glow Strong"
{
    Properties
    {
