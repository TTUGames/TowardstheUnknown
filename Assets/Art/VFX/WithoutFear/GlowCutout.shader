...
Shader "Komorebi/gloutwithoutfear"
{
	Properties
	{
		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float2 texCoord76 = i.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float2 panner77 = ( _Time.y * _MainSpeed + texCoord76);
					...
					float2 uv2_NoiseTex = i.ase_texcoord5.xy * _NoiseTex_ST.xy + _NoiseTex_ST.zw;
					float3 texCoord65 = i.texcoord.xyz;
					texCoord65.xy = i.texcoord.xyz.xy * float2( 1,1 ) + float2( 0,0 );
					float smoothstepResult69 = smoothstep( 0.0 , _NoiseAdjust , ( tex2D( _NoiseTex, uv2_NoiseTex ).r - ( _AlphaCutout + texCoord65.z ) ));
...
/*ASEBEGIN
Version=19100
Node;AmplifyShaderEditor.RangedFloatNode;88;-1847.368,450.7298;Float;False;Property;_FresnelScale;Fresnel Scale;0;0;Create;True;0;0;0;False;0;False;0.510905;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-1839.389,531.5894;Float;False;Property;_FresnelPower;Fresnel Power;1;0;Create;True;0;0;0;False;0;False;2;0.3;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-1365.879,971.9526;Float;False;Property;_AlphaCutout;Alpha Cutout;3;0;Create;True;0;0;0;False;0;False;0;-0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;52;-1252.481,-243.2147;Float;False;Property;_GlowColor;Glow Color;7;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;78;-293.4479,-442.0886;Float;False;Property;_MainSpeed;Main Speed;8;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;59;-1503.932,679.8417;Inherit;True;Property;_NoiseTex;Noise Tex;2;0;Create;True;0;0;0;False;0;False;-1;140c5b15ccac91a4fb58b5ea4666c02f;140c5b15ccac91a4fb58b5ea4666c02f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;94;-930.5882,838.1804;Float;False;Property;_NoiseAdjust;Noise Adjust;6;0;Create;True;0;0;0;False;0;False;1;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;85;-111.1167,-632.9122;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;82;744.1886,366.639;Float;False;Property;_MaskClipValue;Mask Clip Value;5;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=8EC4C95594CED3A629155AB1328C3D5809FAFBE9