...
| `SkillsBar` | The artifacts of the inventory; clicking one selects it, hovering shows its effects (`Tooltip`, styled placement, above the middle of the bar); a skill that can't be cast shakes when selected (`PlayerAttack.ArtifactRefused`) |
